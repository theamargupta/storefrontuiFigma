...
export default function Navbar() {
  ...
  return (
    <header className="flex justify-center w-full py-2  lg:py-5 bg-white border-b border-neutral-200 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-wrap lg:flex-nowrap items-center flex-row justify-start h-full max-w-[1536px] w-full">
        <Link href="/" className="w-[8%]">
          <h1 className="text-2xl font-bold text-[#6E32F0]">Qape</h1>
        </Link>
        {/* <a
          href="#"
